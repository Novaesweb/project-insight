---
description: Contexto Geral e Regras de Negócio do Projeto Novaesweb
---

# Projeto: Novaesweb Premium Platform
...
2.  **Painel Admin** (`/admin`): Onde a Novaesweb gerencia clientes, projetos, leads, configurações globais do site e a loja de "Extras".
...
## 3. Padrões de Interface e UX (A "Assinatura" Novaesweb)
