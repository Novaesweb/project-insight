...
const baseVars: ContractVariable[] = [
  ...
  { key: "cnpj_novaes", label: "CNPJ NovaesWeb", type: "text", defaultValue: "" },
...
CONTRATADA: NovaesWeb, CNPJ {cnpj_novaes}, sediada em Alvorada, RS, doravante denominada CONTRATADA.
