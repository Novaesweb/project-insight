...
export const PUBLIC_PLAN_CATALOG: PublicPlanCatalogItem[] = [
  {
    ...
    description:
      "A base sólida para colocar sua presença digital no ar com velocidade e aparência profissional.",
    oldPrice: 597,
    setupPrice: 180,
    monthlyPrice: 0,
    monthlyNote: "+ R$ 60/mês com automação de WhatsApp opcional",
  ...
  },
  {
    ...
    description:
      "Ecossistema desenhado para automatizar processos, organizar clientes e escalar resultados com estrutura própria.",
    oldPrice: 1200,
    setupPrice: 349,
    monthlyPrice: 0,
  ...
  },
  {
    ...
    description:
      "Para operações que precisam de sistemas internos, dashboards, marketing de atração e estrutura técnica personalizada.",
    setupPrice: 0,
    monthlyPrice: 0,
