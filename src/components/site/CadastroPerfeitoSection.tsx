...
export default function CadastroPerfeitoSection() {
  ...
  return (
    <section id="cadastro" className="min-h-screen bg-novaes-bg flex items-center justify-center p-4 lg:p-8 font-inter text-white overflow-hidden relative">
      ...
      <div className="w-full max-w-7xl min-h-[700px] h-auto lg:h-[850px] bg-black/20 backdrop-blur-[40px] rounded-[32px] flex flex-col lg:flex-row shadow-[0_50px_100px_rgba(0,0,0,0.4)] overflow-hidden relative border border-white/5 z-10">
          ...
          <div className="z-10 relative">
            <div className="flex items-center gap-4 mb-16 group">
              ...
              <div className="flex flex-col text-left">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.4em] opacity-40">Premium CRM</span>
              </div>
            </div>
        ...
        <div className="flex-1 flex flex-col relative bg-[#0a0a0f]/40">
              ...
              {currentStep === 0 && (
                <motion.div key="s0" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -30 }} className="text-center lg:text-left space-y-12">
                  ...
                  <div className="space-y-6">
                    <h1 className="text-5xl lg:text-8xl font-black tracking-tighter font-space leading-[0.85]">VAMOS <br /> <span className="opacity-20 italic">ELEVAR SEU</span> <br /> NEGÓCIO?</h1>
                    <p className="text-white/40 text-xl font-medium max-w-md leading-relaxed">Sua jornada para a perfeição digital começa aqui.</p>
                  </div>
                      ...
                      <button 
                        ...
                        className={cn("flex flex-col items-center justify-center p-8 lg:p-12 rounded-[2.5rem] border-2 transition-all gap-4 group relative overflow-hidden",
                          (currentStep === 5 ? form.necessidade : form.origem) === opt.id 
                            ? "bg-white/10 border-primary-novaes shadow-2xl shadow-primary-novaes/20" 
                            : "bg-white/[0.02] border-white/5 hover:border-white/20"
                        )}
                      >
                        <opt.icon className={cn("w-12 h-12 transition-transform group-hover:scale-110", 
                          (currentStep === 5 ? form.necessidade : form.origem) === opt.id ? "text-primary-novaes" : "text-white/20")} 
                        />
                  ...
                  <div className="grid grid-cols-1 gap-4 lg:gap-6">
                    {VOLUMES.map(opt => (
                      ...
                      >
                        ...
                        {form.volume === opt.id && (
                          <motion.div layoutId="vol-glow-site" className="absolute inset-0 bg-primary-novaes/10 blur-2xl -z-10" />
                        )}
                      </button>
                    ))}
                  </div>
          ...
          {currentStep > 0 && currentStep < 9 && (
            <div className="p-8 lg:p-24 pt-0 flex items-center justify-between mt-auto">
