  ...
  return (
    <section id="home" className="relative min-h-[95vh] flex items-center justify-center overflow-hidden pt-20 pb-12">
      ...
      <div className="absolute inset-0 z-0" aria-hidden="true">
        ...
        <div className="absolute bottom-1/4 -right-20 w-[600px] h-[600px] rounded-full blur-[160px] opacity-[0.06]" style={{ background: 'radial-gradient(circle, #ec4899, transparent 70%)', willChange: 'transform', transform: 'translateZ(0)' }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full blur-[180px] opacity-[0.04]" style={{ background: 'radial-gradient(circle, #ff3366, transparent 70%)' }} />
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl lg:text-[5.5rem] font-black mb-8 tracking-tighter leading-[0.85] text-white/90"
          >
            <span className="block">Estruturas digitais que</span>
            <span className="gradient-text block">atraem clientes</span>
            <span className="block text-white/50">todos os dias</span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-white/40 mb-14 max-w-2xl mx-auto leading-relaxed font-medium"
          >
          ...
          >
            <Button
              onClick={onOpenDemo}
              className="h-16 px-12 rounded-2xl text-white text-lg font-black shadow-[0_20px_50px_rgba(168,85,247,0.25)] hover:shadow-[0_25px_60px_rgba(168,85,247,0.4)] hover:scale-105 transition-all group border-0 relative overflow-hidden"
          ...
          >
            {[
              ...
              <div key={stat.label} className="text-center">
                ...
                <p className="text-[10px] text-white/25 uppercase tracking-[0.2em] font-bold mt-1">{stat.label}</p>
              </div>
            ))}
          </motion.div>
          ...
          <motion.div
            ...
            className="mt-16 pt-10 border-t border-white/[0.04] flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-25 hover:opacity-60 transition-opacity duration-500"
          >
