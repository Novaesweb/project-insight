      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <motion.button
              type="button"
              onClick={() => navigate("/criacao-conteudo")}
              whileHover={{ scale: 1.03 }}
              className="site-surface h-14 px-8 rounded-2xl text-sm font-bold inline-flex items-center gap-2 transition-colors"
              style={{
                color: 'hsl(var(--muted-foreground) / 0.9)',
          ...
          <motion.div
            ...
            className="mt-14 lg:mt-16 grid grid-cols-3 gap-4 max-w-xl mx-auto"
          >
            {[
          ...
          <motion.div
            ...
            className="mt-12 lg:mt-14 pt-10 flex flex-wrap justify-center items-center gap-8 md:gap-14"
