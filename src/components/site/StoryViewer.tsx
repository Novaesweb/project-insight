...
const stories: Record<string, Story> = {
  geral: {
    ...
    slides: [
      ...
      { title: "novaesweb", subtitle: "Construindo o Futuro Digital do seu negócio.", image: "https://images.unsplash.com/photo-1551434678-e076c223a692?q=80&w=800", icon: "💎" }
    ]
  },
  delivery: {
    id: "delivery",
      ...
      <div className="relative w-full h-[100dvh] sm:h-auto sm:max-w-[420px] sm:aspect-[9/16] bg-[#070714] sm:rounded-3xl overflow-hidden shadow-2xl flex flex-col">
        ...
        <div className="absolute top-8 left-4 right-4 z-20 flex items-center justify-between px-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-white text-xs font-bold leading-none tracking-wide">novaesweb</p>
